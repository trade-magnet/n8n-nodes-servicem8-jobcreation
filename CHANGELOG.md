...
- Contact lookup no longer uses the OData `or` operator (ServiceM8 returns 400 Bad Request). Now issues one GET per provided identifier (email/mobile/phone) and merges + dedupes the results client-side.
